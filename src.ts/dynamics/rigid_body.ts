...
export class RigidBody {
    private set: RigidBodySet; // The RigidBody won't need to free this.
    readonly handle: RigidBodyHandle;

    constructor(set: RigidBodySet, handle: RigidBodyHandle) {
        this.set = set;
        this.handle = handle;
    }
    ...
    public isValid(): boolean {
        return this.set.raw.contains(this.handle);
    }
    ...
    public lockTranslations(locked: boolean, wakeUp: boolean) {
        return this.set.raw.rbLockTranslations(this.handle, locked, wakeUp);
    }
    ...
    public lockRotations(locked: boolean, wakeUp: boolean) {
        return this.set.raw.rbLockRotations(this.handle, locked, wakeUp);
    }
    ...
    public restrictTranslations(enableX: boolean, enableY: boolean, wakeUp: boolean) {
        return this.set.raw.rbRestrictTranslations(this.handle, enableX, enableY, wakeUp);
    }
    // #endif
    // #if DIM3
    /**
    ...
    public restrictTranslations(enableX: boolean, enableY: boolean, enableZ: boolean, wakeUp: boolean) {
        return this.set.raw.rbRestrictTranslations(this.handle, enableX, enableY, enableZ, wakeUp);
    }
    ...
    public restrictRotations(enableX: boolean, enableY: boolean, enableZ: boolean, wakeUp: boolean) {
        return this.set.raw.rbRestrictRotations(this.handle, enableX, enableY, enableZ, wakeUp);
    }
    // #endif
    ...
    public dominanceGroup(): number {
        return this.set.raw.rbDominanceGroup(this.handle);
    }
    ...
    public setDominanceGroup(group: number) {
        this.set.raw.rbSetDominanceGroup(this.handle, group);
    }
    ...
    public enableCcd(enabled: boolean) {
        this.set.raw.rbEnableCcd(this.handle, enabled)
    }
    ...
    public translation(): Vector {
        let res = this.set.raw.rbTranslation(this.handle);
    ...
    public rotation(): Rotation {
        let res = this.set.raw.rbRotation(this.handle);
    ...
    public nextTranslation(): Vector {
        let res = this.set.raw.rbNextTranslation(this.handle);
        return VectorOps.fromRaw(res);
    }
    ...
    public nextRotation(): Rotation {
        let res = this.set.raw.rbNextRotation(this.handle);
        return RotationOps.fromRaw(res);
    }
    ...
    public setTranslation(tra: Vector, wakeUp: boolean,) {
        // #if DIM2
        this.set.raw.rbSetTranslation(this.handle, tra.x, tra.y, wakeUp);
        // #endif
        // #if DIM3
        this.set.raw.rbSetTranslation(this.handle, tra.x, tra.y, tra.z, wakeUp);
        // #endif
    }
    ...
    public setLinvel(vel: Vector, wakeUp: boolean) {
        ...
        this.set.raw.rbSetLinvel(this.handle, rawVel, wakeUp);
        rawVel.free();
    }
    ...
    public gravityScale(): number {
        return this.set.raw.rbGravityScale(this.handle);
    }
    ...
    public setGravityScale(factor: number, wakeUp: boolean) {
        this.set.raw.rbSetGravityScale(this.handle, factor, wakeUp);
    }
    ...
    public setRotation(rot: Rotation, wakeUp: boolean) {
        this.set.raw.rbSetRotation(this.handle, rot.x, rot.y, rot.z, rot.w, wakeUp);
    }
    ...
    public setAngvel(vel: Vector, wakeUp: boolean) {
        let rawVel = VectorOps.intoRaw(vel);
        this.set.raw.rbSetAngvel(this.handle, rawVel, wakeUp);
        rawVel.free();
    }
    ...
    public setRotation(angle: number, wakeUp: boolean) {
        this.set.raw.rbSetRotation(this.handle, angle, wakeUp);
    }
    ...
    public setAngvel(vel: number, wakeUp: boolean) {
        this.set.raw.rbSetAngvel(this.handle, vel, wakeUp);
    }
    ...
    public setNextKinematicTranslation(t: Vector) {
        // #if DIM2
        this.set.raw.rbSetNextKinematicTranslation(this.handle, t.x, t.y);
        // #endif
        // #if DIM3
        this.set.raw.rbSetNextKinematicTranslation(this.handle, t.x, t.y, t.z);
        // #endif
    }
    ...
    public setNextKinematicRotation(rot: Rotation) {
        this.set.raw.rbSetNextKinematicRotation(this.handle, rot.x, rot.y, rot.z, rot.w);
    }
    ...
    public setNextKinematicRotation(angle: number) {
        this.set.raw.rbSetNextKinematicRotation(this.handle, angle);
    }
    ...
    public linvel(): Vector {
        return VectorOps.fromRaw(this.set.raw.rbLinvel(this.handle));
    }
    ...
    public angvel(): Vector {
        return VectorOps.fromRaw(this.set.raw.rbAngvel(this.handle));
    }
    ...
    public angvel(): number {
        return this.set.raw.rbAngvel(this.handle);
    }
     ...
     */
    public mass(): number {
        return this.set.raw.rbMass(this.handle);
    }
     ...
     */
    public sleep() {
        this.set.raw.rbSleep(this.handle);
    }
     ...
     */
    public wakeUp() {
        this.set.raw.rbWakeUp(this.handle);
    }
     ...
     */
    public isCcdEnabled() {
        this.set.raw.rbIsCcdEnabled(this.handle);
    }
    ...
    public numColliders(): number {
        return this.set.raw.rbNumColliders(this.handle);
    }
    ...
    public collider(i: number): ColliderHandle {
        return this.set.raw.rbCollider(this.handle, i);
    }
    ...
    public bodyType(): RigidBodyType {
        return this.set.raw.rbBodyType(this.handle);
    }
    ...
    public isSleeping(): boolean {
        return this.set.raw.rbIsSleeping(this.handle);
    }
    ...
    public isMoving(): boolean {
        return this.set.raw.rbIsMoving(this.handle);
    }
    ...
    public isStatic(): boolean {
        return this.set.raw.rbIsStatic(this.handle);
    }
    ...
    public isKinematic(): boolean {
        return this.set.raw.rbIsKinematic(this.handle);
    }
    ...
    public isDynamic(): boolean {
        return this.set.raw.rbIsDynamic(this.handle);
    }
    ...
    public linearDamping(): number {
        return this.set.raw.rbLinearDamping(this.handle);
    }
    ...
    public angularDamping(): number {
        return this.set.raw.rbAngularDamping(this.handle);
    }
    ...
    public setLinearDamping(factor: number) {
        this.set.raw.rbSetLinearDamping(this.handle, factor);
    }
    ...
    public setAngularDamping(factor: number) {
        this.set.raw.rbSetAngularDamping(this.handle, factor);
    }
    ...
    public applyForce(force: Vector, wakeUp: boolean) {
        ...
        this.set.raw.rbApplyForce(this.handle, rawForce, wakeUp);
        rawForce.free();
    }
    ...
    public applyImpulse(
        ...
        this.set.raw.rbApplyImpulse(this.handle, rawImpulse, wakeUp);
        rawImpulse.free();
    }
    ...
    public applyTorque(torque: number, wakeUp: boolean) {
        this.set.raw.rbApplyTorque(this.handle, torque, wakeUp);
    }
    ...
    public applyTorque(torque: Vector, wakeUp: boolean) {
        ...
        this.set.raw.rbApplyTorque(this.handle, rawTorque, wakeUp);
        rawTorque.free();
    }
    ...
    public applyTorqueImpulse(torqueImpulse: number, wakeUp: boolean) {
        this.set.raw.rbApplyTorqueImpulse(this.handle, torqueImpulse, wakeUp);
    }
    ...
    public applyTorqueImpulse(torqueImpulse: Vector, wakeUp: boolean) {
        ...
        this.set.raw.rbApplyTorqueImpulse(this.handle, rawTorqueImpulse, wakeUp);
    ...
    public applyForceAtPoint(
        ...
        this.set.raw.rbApplyForceAtPoint(this.handle, rawForce, rawPoint, wakeUp);
        rawForce.free();
        rawPoint.free();
    }
    ...
    public applyImpulseAtPoint(
        ...
        const rawImpulse = VectorOps.intoRaw(impulse);
        const rawPoint = VectorOps.intoRaw(point);
        this.set.raw.rbApplyImpulseAtPoint(this.handle, rawImpulse, rawPoint, wakeUp);
        rawImpulse.free();
        rawPoint.free();
    }
    ...
    public set userData(data: unknown) {
        this.set.userDataSet.set(this.handle, data);
    }
    ...
    public get userData(): unknown {
        return this.set.userDataSet.get(this.handle);
    }
}
