...
const buildTypescript = async () => {
  ...
  fs.writeFileSync(packageJsonPath, fs
    .readFileSync(packageJsonPath)
    .toString()
    .replaceAll(/"module":\s*"rapier_wasm3d.js"/g, "\"module\": \"rapier.js\"")
    .replaceAll(/"types":\s*"rapier_wasm3d.d.ts"/g, "\"types\": \"rapier.d.ts\"")
  );
};
...
const buildDoc = async () => {
  ...
  await wait(spawn("npx", ["typedoc", "--tsconfig", "tsconfig_typedoc.json"], {
    shell: true,
    stdio: "inherit",
    cwd: "./rapier3d/",
  }));
